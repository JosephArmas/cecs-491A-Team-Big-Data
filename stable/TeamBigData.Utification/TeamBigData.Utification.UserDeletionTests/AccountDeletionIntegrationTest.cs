...
namespace TeamBigData.Utification.AccountDeletionTests
{
    ...
    public class AccountDeletionIntegrationTest
    {
        ...
        {
            //Arrange
            IDBSelecter testDBO = new SqlDAO(@"Server=.;Database=TeamBigData.Utification.Users;Uid=root;Pwd=root;Encrypt=False");
            IDAO featDBO = new SqlDAO(@"Server=.;Database=TeamBigData.Utification.Features;Uid=root;Pwd=root;Encrypt=False");
