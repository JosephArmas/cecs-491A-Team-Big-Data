...
(function (root) {
    ...
    function placeNewPin(latLng, map) {
        ...
        .catch(function (error){
            //do not assume there wont be errors
        });
    }
   
    //create name space of app that returns an object that hasa function that start the map to protect internals
    //hardcoding like this makes it hard to maintain long term
    //not following abstarctions since this is hard coded this google map vendor directly
    //lacks extensibility
    //create a mapping layer to have baked in functionalities
    //UI->abstarction map (our baked on functionalities)->google map functionalities
    //abstraction layers on top of technologies makes it easier to address breaking changes
    //not following oop
    //mixing business rules with integration technologies which makes it less extensible
    //consistent with lets and vars and its usually let since var is the global
