        ...
        */
        ...
        public async Task<Response> VerifyUser(String username, byte[] encryptedPassword, Encryptor encryptor)
        {
            ...
            if (_user == null)
            {
                ...
                {
                    // if (result.errorMessage.Equals("Error: Invalid  username or password provided. Retry again or contact system administrator"))
        ...
        public Response GetUserProfileTable(List<UserProfile> list, UserProfile userProfile)
        {
            ...
            var connection = @"Server=localhost;port=3306;Database=dbo;Uid=root;Pwd=user;";
