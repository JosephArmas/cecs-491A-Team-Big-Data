...
namespace TeamBigData.Utification.Manager
{
    public class SecurityManager
    {
        ...
        //testing purpose
        public string localconn = @"Server=localhost;port=3306;Database=dbo;Uid=root;Pwd=user";
        ...
        */
        public Response InsertUser(String email, byte[] encryptedPassword, Encryptor encryptor)
        {
            ...
            IDBInserter sqlDAO = new SqlDAO(localconn);
            ...
            stopwatch.Stop();
            Log log;
            var logger = new Logger(new SqlDAO(@"Server=localhost;port=3306;Database=dbo;Uid=root;Pwd=user;"));
        ...
        public async Task<Response> VerifyUser(String username, byte[] encryptedPassword, Encryptor encryptor)
        {
            ...
            if (_user == null)
            {
                // var logConnectionString = @"Server=localhost;port=3306;Database=dbo;Uid=root;Pwd=user;";
                var logDAO = new SqlDAO(localconn);
                ...
                // var connectionString = @"Server=localhost;port=3306;Database=dbo;Uid=root;Pwd=user;";
                var userDao = new SqlDAO(localconn);
                ...
                else
                {
                    ...
                    // if (result.errorMessage.Equals("Invalid username or password provided. Retry again or contact system administrator"))
                    {
        ...
        public Response GetUserProfileTable(ref List<UserProfile> list, UserProfile userProfile)
        {
            ...
            // var connection = @"Server=.\;Database=TeamBigData.Utification.Users;Integrated Security=True;Encrypt=False";
            IDBSelecter selectDAO = new SqlDAO(localconn);
        ...
        public async Task<Response> RecoverAccount(String username, Byte[] encryptedPassword, Encryptor encryptor, String enteredOTP)
        {
            ...
            // var connectionString = @"Server=.\;Database=TeamBigData.Utification.Users;Integrated Security=True;Encrypt=False";
            SqlDAO userDao = new SqlDAO(localconn);
        ...
        public Response GetRecoveryRequests(ref List<string> requests, UserProfile userProfile)
        {
            ...
            // var connectionString = @"Server=.\;Database=TeamBigData.Utification.Users;Integrated Security = True;Encrypt=False";
            var recoveryDao = new SqlDAO(localconn);
