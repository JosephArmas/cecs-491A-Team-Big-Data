...
namespace TeamBigData.Utification.LoggingTest
{
    ...
    public class DataAccessTest
    {
        ...
        {
            //Arrange
            var sysUnderTest = new SqlDAO(connectionString:@"Server=localhost;port=3306;Database=dbo;Uid=root;Pwd=user;");
        ...
        public void DAO_MustLogWithin5Secs()
        {
            ...
            var expected = 5000;
            var sysUnderTest = new Logger(new SqlDAO(connectionString:@"Server=localhost;port=3306;Database=dbo;Uid=root;Pwd=user;"));
