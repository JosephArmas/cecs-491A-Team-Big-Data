...
using TeamBigData.Utification.UserManager;
...
namespace TeamBigData.Utification.SecurityManager
{
    public class SecurityManager
    {
        ...
        public Response GetUserProfileTable()
        {
            var response = new Response();
            response.isSuccessful = false;
            var connection = @"Server=.\;Database=TeamBigData.Utification.Users;Integrated Security=True;Encryption=False";
