...
namespace TeamBigData.Utification.ReputationManager
{
    public class ReputationManager
    {
        ...
        public async Task<DataResponse<double>> ViewCurrentReputationAsync(int user)
        {
            ...
            {
                getReputation.IsSuccessful = true;
            ...
            {
                getReputationLog = new Log(1, "Error", _userAccount.UserHash, "ReputationService.GetCurrentReputationAsync()", "Data", "Failed to retrieve users reputation from the data store");
            }
        ...
        public async Task<Response> ViewUserReportsAsync()
        {
            ...
            getReportsLog = new Log(1, "Info", _userAccount.UserHash, "ReputationService.GetUserReports()", "Data", "Successfully retrieved reports from the data store");
            await _logger.Logs(getReportsLog).ConfigureAwait(false);
