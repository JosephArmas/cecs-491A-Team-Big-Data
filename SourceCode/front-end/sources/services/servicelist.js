function serviceClicked() {
  ...
  cancelBtn.addEventListener("click", event => {
      var request = axios.post('https://localhost:7259/UserServices/CancelRequest',{},{
        headers: {
  ...
  requestBtn.addEventListener("click", event => {
      var request = axios.post('https://localhost:7259/UserServices/CreateRequest',{RequestID: 0, ServiceID: 0, ServiceName: "Gack",
  Requester: 12, RequestLat: "0.0",RequestLong: "0.0",PinType: 2,Accept: 2, Distance: 24},{
        headers: {
          'Authorization': `Bearer ${localStorage.getItem("jwtToken")}`
        }
      });
  ...
  acceptBtn.addEventListener("click", event => {
      var request = axios.post('https://localhost:7259/UserServices/AcceptRequest',{},{
        headers: {
          'Authorization': `Bearer ${localStorage.getItem("jwtToken")}`
        }
      });
  ...
  denyBtn.addEventListener("click", event => {
      var request = axios.post('https://localhost:7259/UserServices/DenyRequest',{},{
        headers: {
          'Authorization': `Bearer ${localStorage.getItem("jwtToken")}`
        }
      });
  ...
  function servicesForPin(){
  var parent = document.getElementById("distanceForm");
  var dist = document.getElementById("distance");
  function onClickBtn(){
  if(dist.value >= 1 && dist.value <= 25){
  dist.value = "";
  parent.close();
  ...
  document.getElementById("continue").addEventListener("click",onClickBtn);
  parent.showModal();
  }
